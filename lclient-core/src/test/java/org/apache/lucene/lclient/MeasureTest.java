...
public class MeasureTest {
  ...
  public void test004() throws IOException {
    ...
    System.out.println(" firstSumF:"+dSum+" time:"+stopwatch1);
    ...
    double secondSum1 = StreamSupport.stream(
      ...
      .reduce(0, Double::sum);
    System.out.println("secondSum1:"+secondSum1+" time:"+stopwatch1);
    ...
    double secondSum2 = StreamSupport.stream(
      ...
      .mapToDouble(doc -> doc.getField("price").numericValue().doubleValue())
      .reduce(0, Double::sum);
    System.out.println("secondSum2:"+secondSum2+" time:"+stopwatch1);
    ...
    double secondSum3 =
      new LQuery(cmd) 
        ...
        .mapToDouble(doc -> doc.getField("price").numericValue().doubleValue())
        .reduce(0, Double::sum);
    System.out.println("secondSum3:"+secondSum3+" time:"+stopwatch1);
    ...
    double secondSum4 =
      new LQuery(cmd) 
        ...
        .mapToDouble(doc -> doc.getField("price").numericValue().doubleValue())
        .reduce(0, Double::sum);
    System.out.println("secondSum4:"+secondSum4+" time:"+stopwatch1);
  ...
  public void test005() throws IOException {
    ...
    System.out.println("group by tag:"+stopwatch1);
